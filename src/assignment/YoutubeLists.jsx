...
export const YoutubeLists = () => {
    const [data, setData] = useState({});

    const getYoutubeLists = async (page) => {
        try {
            const response = await fetch(
                `https://api.freeapi.app/api/v1/public/youtube/videos?page=${page}&limit=8`,
            );
    ...
    return (
        <div className="w-full min-h-screen bg-neutral-950 text-neutral-100">
            <div className="flex items-center justify-start">
                ...
                <div className="grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] w-full bg-red-500">
                    {data && data.data &&
                        data.map((video) => {
                            return (
                                <div
